...
void Upstairs::execute(BipedalController* controller, const ros::Time& time, const ros::Duration& period)
{
  ...
  double theta_des_l{ M_PI_2 + 0.3 }, theta_des_r{ M_PI_2 + 0.3 }, length_des_l{ 0.17 }, length_des_r{ 0.17 };
  ...
  // Exit
  if ((left_pos_[0] < 0.2 && left_pos_[1] > (M_PI_2 - 0.3)) && (right_pos_[0] < 0.2 && right_pos_[1] > (M_PI_2 - 0.3)))
  {
